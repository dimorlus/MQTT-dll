 ...
 */
DLLExport int _CALL_ MQTTClient_setCallbacks(MQTTClient handle, void* context,
 ...
 */
DLLExport int _CALL_ MQTTClient_create(MQTTClient* handle, const char* serverURI,
                const char* clientId,
...
/**
  ...
  */
DLLExport MQTTClient_nameValue* _CALL_ MQTTClient_getVersionInfo(void);
...
/**
  ...
  */
DLLExport int _CALL_ MQTTClient_connect(MQTTClient handle,
...
/**
  ...
  * from the server
  */
DLLExport int _CALL_ MQTTClient_disconnect(MQTTClient handle, int timeout);
...
/**
  ...
  */
DLLExport int _CALL_ MQTTClient_isConnected(MQTTClient handle);
...
/**
  ...
  * subscription.
  */
DLLExport int _CALL_ MQTTClient_subscribe(MQTTClient handle, const char* topic, int qos);
...
/**
  ...
  * subscriptions.
  */
DLLExport int _CALL_ MQTTClient_subscribeMany(MQTTClient handle, int count,
...
/**
  ...
  * subscription.
  */
DLLExport int _CALL_ MQTTClient_unsubscribe(MQTTClient handle, const char* topic);
...
/**
  ...
  */
DLLExport int _CALL_ MQTTClient_unsubscribeMany(MQTTClient handle, int count,
                char* const* topic);
...
/**
  ...
  */
DLLExport int _CALL_ MQTTClient_publish(MQTTClient handle, const char* topicName,
...
/**
  ...
  * An error code is returned if there was a problem accepting the message.
  */
DLLExport int _CALL_ MQTTClient_publishMessage(MQTTClient handle,
                const char* topicName, MQTTClient_message* msg,
                MQTTClient_deliveryToken* dt);
...
/**
  ...
  * checking the token.
  */
DLLExport int _CALL_ MQTTClient_waitForCompletion(MQTTClient handle,
                MQTTClient_deliveryToken dt, unsigned long timeout);
...
/**
  ...
  * pending tokens.
  */
DLLExport int _CALL_ MQTTClient_getPendingDeliveryTokens(MQTTClient handle,
...
/**
  ...
  */
DLLExport void _CALL_ MQTTClient_yield(void);
...
/**
  ...
  */
DLLExport int _CALL_ MQTTClient_receive(MQTTClient handle, char** topicName,
...
/**
  ...
  * to be freed.
  */
DLLExport void _CALL_ MQTTClient_freeMessage(MQTTClient_message** msg);
...
/**
  ...
  */
DLLExport void _CALL_ MQTTClient_free(void* ptr);
...
/**
  ...
  */
DLLExport void _CALL_ MQTTClient_destroy(MQTTClient* handle);
